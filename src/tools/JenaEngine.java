...
//		 create an empty model
   ...
   /**
    ...
    //read the value of property of type ObjectType
  	static public String readObjectType(Model model, String namespace,
  		...
  		if ((rs != null) && (p != null)) {
  			...
  			if (!it.hasNext()) {
  				...
  				while (it.hasNext()) {
  					...
  					ret = readRsDataType(model, namespace, re, "name");
  	...
  	static public String readDataType(Model model, String namespace,
  			String objectName, String propertyName) {
  		String ret = "";
  		Resource rs = model.getResource(namespace + objectName);
  		Property p = model.getProperty(namespace + propertyName);
  		if ((rs != null) && (p != null)) {
  			if (rs.getProperty(p) != null) {
  				ret = rs.getProperty(p).getString();
 ...
 // read the value of property of type DataType from a resource
 	static public String readRsDataType(Model model, String namespace,
